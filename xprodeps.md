...
|<a id='wxWidgets' />[wxWidgets](http://wxwidgets.org/)|[wxWindows](https://wxwidgets.org/about/licence/ 'essentially LGPL with an exception')|Cross-Platform C++ GUI Library [pvt deps: _OpenGL_]|[xpv3.1.0.8](https://github.com/externpro/wxWidgets/releases/tag/xpv3.1.0.8 'release')|[repo](https://github.com/externpro/wxWidgets 'github.com/externpro/wxWidgets') [upstream](https://github.com/wxWidgets/wxWidgets 'github.com/wxWidgets/wxWidgets')|[diff](https://github.com/externpro/wxWidgets/compare/v3.1.0...xpv3.1.0.8 'github.com/externpro/wxWidgets/compare/v3.1.0...xpv3.1.0.8') [intro[msw], native[unix]]|
